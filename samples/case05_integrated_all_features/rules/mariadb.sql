...
INSERT INTO cfg_address_group (fab_name, firewall_id, group_name, members) VALUES
  ('FAB', 'FW1', 'SRC_ALL', '["SRC_NET_10","SRC_HOST_20_10"]'),
  ('FAB', 'FW1', 'DST_SENSITIVE', '["DST_DB_HOST"]');
...
VALUES
  ...
  ( 'FAB', 'FW1', 52, 52, '["SRC_ALL"]', '["DST_WEB_NET"]', '["HTTP"]', 'accept', 'enable', 'all', 'allow http to web from all sources');
