...
INSERT INTO cfg_address (object_name, address_type, subnet, start_ip, end_ip) VALUES
  ('SRC_NET', 'subnet', '10.30.0.0/24', NULL, NULL),
  ('DST_NET', 'subnet', '172.30.0.0/24', NULL, NULL);

INSERT INTO cfg_address_group (group_name, members) VALUES
  ('AG_SRC_PLACEHOLDER', '["SRC_NET"]'),
  ('AG_DST_PLACEHOLDER', '["DST_NET"]');
...
INSERT INTO cfg_policy (priority, policy_id, src_objects, dst_objects, service_object, action, is_enabled, log_traffic, comments) VALUES
  (1, '1', '["SRC_NET"]', '["DST_NET"]', '["SG_MAIN"]', 'accept', 1, 1, 'allow service group'),
  (2, '2', '["SRC_NET"]', '["DST_NET"]', '["ALL"]', 'deny', 1, 1, 'deny other services'),
  (3, '3', '["SRC_NET"]', '["DST_NET"]', '["SG_EXTRA"]', 'accept', 0, 0, 'disabled extra group');
