...
INSERT INTO cfg_address (object_name, address_type, subnet, start_ip, end_ip) VALUES
  ('SRC_IN', 'subnet', '10.50.0.0/24', NULL, NULL),
  ('SRC_OUT', 'subnet', '10.51.0.0/24', NULL, NULL),
  ('DST_IN', 'subnet', '172.50.0.0/24', NULL, NULL),
  ('DST_OUT', 'subnet', '172.51.0.0/24', NULL, NULL);
...
INSERT INTO cfg_policy (priority, policy_id, src_objects, dst_objects, service_object, action, is_enabled, log_traffic, comments) VALUES
  (1, '1', '["AG_SRC_IN"]', '["AG_DST_IN"]', '["SG_MAIN"]', 'accept', 1, 1, 'allow group + service group'),
  (2, '2', '["AG_SRC_IN"]', '["DST_OUT"]', '["ALL"]', 'deny', 1, 1, 'deny src group to dst out'),
  (3, '3', '["SRC_OUT"]', '["AG_DST_IN"]', '["ALL"]', 'deny', 1, 1, 'deny src out to dst group'),
  (4, '4', '["AG_SRC_IN"]', '["AG_DST_IN"]', '["SG_EXTRA"]', 'accept', 0, 0, 'disabled cross rule');
