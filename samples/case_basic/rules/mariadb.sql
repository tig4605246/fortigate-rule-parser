...
INSERT INTO cfg_address (object_name, address_type, subnet, start_ip, end_ip) VALUES
  ('SRC_NET_BASIC', 'subnet', '10.10.0.0/24', NULL, NULL),
  ('SRC_HOST_BASIC', 'subnet', '10.10.1.10/32', NULL, NULL),
  ('DST_NET_BASIC', 'subnet', '172.16.0.0/24', NULL, NULL),
  ('DST_HOST_DB', 'subnet', '172.16.1.5/32', NULL, NULL);

INSERT INTO cfg_address_group (group_name, members) VALUES
  ('AG_SRC_BASIC', '["SRC_NET_BASIC", "SRC_HOST_BASIC"]'),
  ('AG_DST_BASIC', '["DST_NET_BASIC", "DST_HOST_DB"]');
...
INSERT INTO cfg_policy (priority, policy_id, src_objects, dst_objects, service_object, action, is_enabled, log_traffic, comments) VALUES
  (1, '1', '["SRC_HOST_BASIC"]', '["DST_HOST_DB"]', '["SSH"]', 'accept', 1, 1, 'allow ssh to db'),
  (2, '2', '["AG_SRC_BASIC"]', '["DST_HOST_DB"]', '["ALL"]', 'deny', 1, 1, 'deny all to db'),
  (3, '3', '["SRC_NET_BASIC"]', '["DST_NET_BASIC"]', '["HTTP"]', 'accept', 1, 1, 'allow http to web'),
  (4, '4', '["AG_SRC_BASIC"]', '["DST_NET_BASIC"]', '["SSH"]', 'deny', 0, 0, 'disabled sample');
